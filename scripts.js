...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      'hero.stack.value': 'RDBMS (MySQL, MariaDB) / NoSQL (Redis, MongoDB) / Distributed Database Architecture (TiDB) · Terraform/Ansible · Prometheus/Grafana',
    ...
    'zh-TW': {
      ...
      'hero.stack.value': 'RDBMS（MySQL、MariaDB）/NoSQL（Redis、MongoDB）/分散式資料庫架構（TiDB） · Terraform/Ansible · Prometheus/Grafana',
    ...
    'zh-CN': {
      ...
      'hero.stack.value': 'RDBMS（MySQL、MariaDB）/NoSQL（Redis、MongoDB）/分布式数据库架构（TiDB） · Terraform/Ansible · Prometheus/Grafana',
