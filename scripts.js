...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      'hero.stack.value': 'RDBMS/NoSQL/Distributed Database Architecture · Terraform/Ansible · Prometheus/Grafana',
    ...
    'zh-TW': {
      ...
      'hero.stack.value': 'RDBMS/NoSQL/分散式資料庫架構 · Terraform/Ansible · Prometheus/Grafana',
    ...
    'zh-CN': {
      ...
      'hero.stack.value': 'RDBMS/NoSQL/分布式数据库架构 · Terraform/Ansible · Prometheus/Grafana',
