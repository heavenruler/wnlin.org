...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      'hero.specialties.value': 'Database architecture / DBRE\nObservability / Hybrid cloud',
      'hero.stack.label': 'Preferred stack',
      'hero.stack.value': 'RDBMS (MySQL, MariaDB) / Connection-pooling proxy layer (ProxySQL)\nNoSQL (Redis, MongoDB) / Distributed Database Architecture (TiDB)\nTerraform / Ansible / Prometheus / Grafana',
      'hero.stack.item1': 'RDBMS (MySQL, MariaDB)',
      'hero.stack.item2': 'Connection-pooling proxy layer (ProxySQL)',
      'hero.stack.item3': 'NoSQL (Redis, MongoDB)',
      'hero.stack.item4': 'Distributed Database Architecture (TiDB)',
      'hero.stack.item5': 'Terraform / Ansible / Prometheus / Grafana',
    ...
    'zh-TW': {
      ...
      'hero.specialties.value': '資料庫架構 / DBRE\n可觀測性 / 混合雲',
      'hero.stack.label': '偏好技術',
      'hero.stack.value': 'RDBMS（MySQL、MariaDB）/連線池代理層（ProxySQL）\nNoSQL（Redis、MongoDB）/分散式資料庫架構（TiDB）\nTerraform / Ansible / Prometheus / Grafana',
      'hero.stack.item1': 'RDBMS（MySQL、MariaDB）',
      'hero.stack.item2': '連線池代理層（ProxySQL）',
      'hero.stack.item3': 'NoSQL（Redis、MongoDB）',
      'hero.stack.item4': '分散式資料庫架構（TiDB）',
      'hero.stack.item5': 'Terraform / Ansible / Prometheus / Grafana',
    ...
    'zh-CN': {
      ...
      'hero.specialties.value': '数据库架构 / DBRE\n可观测性 / 混合云',
      'hero.stack.label': '偏好技术',
      'hero.stack.value': 'RDBMS（MySQL、MariaDB）/连接池代理层（ProxySQL）\nNoSQL（Redis、MongoDB）/分布式数据库架构（TiDB）\nTerraform / Ansible / Prometheus / Grafana',
      'hero.stack.item1': 'RDBMS（MySQL、MariaDB）',
      'hero.stack.item2': '连接池代理层（ProxySQL）',
      'hero.stack.item3': 'NoSQL（Redis、MongoDB）',
      'hero.stack.item4': '分布式数据库架构（TiDB）',
      'hero.stack.item5': 'Terraform / Ansible / Prometheus / Grafana',
